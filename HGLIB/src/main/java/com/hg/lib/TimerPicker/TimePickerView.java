...
public class TimePickerView extends View {
    ...
    private static class ScrollHandler extends Handler {
        private WeakReference<TimePickerView> mWeakView;

        private ScrollHandler(TimePickerView view) {
            mWeakView = new WeakReference<>(view);
        }

        @Override
        public void handleMessage(Message msg) {
            TimePickerView view = mWeakView.get();
            if (view == null) return;
    ...
    private void initPaint() {
        ...
        mLightColor = ContextCompat.getColor(mContext, R.color.c0099ff);
