...
import com.hg.lib.R;
import com.hg.lib.edit.sticker.IMGSticker;
import com.hg.lib.edit.sticker.IMGStickerAdjustHelper;
import com.hg.lib.edit.sticker.IMGStickerHelper;
import com.hg.lib.edit.sticker.IMGStickerMoveHelper;
...
public abstract class IMGStickerView extends ViewGroup implements IMGSticker, View.OnClickListener {
    ...
    private static final int STROKE_WIDTH = 2;//笔画大小
    ...
    public void draw(Canvas canvas) {
        if (isShowing()) {
            canvas.drawRect(ANCHOR_SIZE_HALF, ANCHOR_SIZE_HALF, getWidth() - ANCHOR_SIZE_HALF, getHeight() - ANCHOR_SIZE_HALF, PAINT);
        }
        super.draw(canvas);
    }
